...
#define SD_CS     10
#endif
#define NAMEMATCH1 "Logo Space Oddity"        // "" matches any name
#define NAMEMATCH2 "MajorTomDesign1 (1)"   // *tiger*.bmp
#define PALETTEDEPTH   0     // do not support Palette modes
//#define PALETTEDEPTH   8     // support 256-colour Palette

String Lectura = "NADA";

char namebuf[32] = "/project/*.bmp";   //BMP files in root directory
